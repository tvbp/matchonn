...
export default function NeedsForm({
  ...
  return (
    ...
    >
      <div>
        <label className="block text-sm font-medium text-stone-700">What are you looking for?</label>
      ...
      <div>
        <label className="block text-sm font-medium text-stone-700">Which city do you live in?</label>
        <select
          value={cityTier}
      ...
      {productType === "term" ? (
        <>
          <div>
            <label className="block text-sm font-medium text-stone-700">Annual income (₹ lakh)</label>
            <input
              type="number"
              min={1}
        ...
        <div>
          <label className="block text-sm font-medium text-stone-700">Family members to cover</label>
          <input
            type="number"
            min={1}
            max={8}
